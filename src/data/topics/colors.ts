...
export const colorsTopic: Topic = {
  ...
  words: [
    ...
    },
    {
      ...
      extraLetters: "YELOWQXZ",
      meaning:
        "A primary color between green and orange on the visible spectrum, associated with brightness and energy",
      pronunciation: "yĕl′ō",
    },
    {
      word: "ORANGE",
      hint: "Color of carrots and pumpkins",
      extraLetters: "ORANGETX",
      meaning:
        "A secondary color made by mixing red and yellow, associated with warmth and enthusiasm",
      pronunciation: "ôr′ĭnj",
    },
    {
      word: "PURPLE",
      hint: "Color of grapes and lavender",
      extraLetters: "PURPLEXZ",
      meaning:
        "A secondary color made by mixing red and blue, associated with royalty and luxury",
      pronunciation: "pûr′pəl",
    },
    {
      word: "PINK",
      hint: "Color of flamingos and cotton candy",
      extraLetters: "PINKQWZ",
      meaning:
        "A pale reddish color that is typically associated with femininity and sweetness",
      pronunciation: "pĭngk",
    },
    {
      word: "BROWN",
      hint: "Color of chocolate and coffee",
      extraLetters: "BROWNXZ",
      meaning:
        "A composite color made by mixing red, yellow and black, associated with earth and wood",
      pronunciation: "broun",
    },
    {
      word: "BLACK",
      hint: "Color of night and coal",
      extraLetters: "BLACKPZ",
      meaning:
        "The darkest color, resulting from the absence or complete absorption of visible light",
      pronunciation: "blăk",
    },
    {
      word: "WHITE",
      hint: "Color of snow and clouds",
      extraLetters: "WHITEPQZ",
      meaning:
        "The lightest color, resulting from the reflection of all visible wavelengths of light",
      pronunciation: "wīt",
    },
    {
      word: "GRAY",
      hint: "Color between black and white",
      extraLetters: "GRAYWXZ",
      meaning:
        "A neutral color between black and white, varying in intensity depending on the mixture",
      pronunciation: "grā",
    },
    {
      word: "GOLD",
      hint: "Color of treasure and medals",
      extraLetters: "GOLDPQZ",
      meaning:
        "A yellow-orange color that resembles the precious metal, associated with wealth and prosperity",
      pronunciation: "gōld",
    },
    {
      word: "SILVER",
      hint: "Color of mirrors and jewelry",
      extraLetters: "SILVERPQ",
      meaning:
        "A grayish-white metallic color that resembles the precious metal, associated with elegance",
      pronunciation: "sĭl′vər",
    },
    {
      word: "BRONZE",
      hint: "Color of third-place medals",
      extraLetters: "BRONZEPQ",
      meaning:
        "A reddish-brown metallic color that resembles the metal alloy, associated with third place",
      pronunciation: "brŏnz",
    },
    {
      word: "TEAL",
      hint: "Blue-green color of tropical waters",
      extraLetters: "TEALPQZ",
      meaning:
        "A medium blue-green color that resembles the color around the eyes of the common teal duck",
      pronunciation: "tēl",
    },
    {
      word: "NAVY",
      hint: "Dark blue color of military uniforms",
      extraLetters: "NAVYXZQ",
      meaning:
        "A very dark blue color traditionally used in naval uniforms, suggesting authority and formality",
      pronunciation: "nā′vē",
    },
    {
      word: "CORAL",
      hint: "Pinkish-orange color of sea formations",
      extraLetters: "CORALXZ",
      meaning:
        "A pinkish-orange color that resembles the marine invertebrates, bright and tropical in appearance",
      pronunciation: "kôr′əl",
    },
    {
      word: "MAROON",
      hint: "Brownish-red color",
      extraLetters: "MAROONXZ",
      meaning:
        "A dark brownish-red color that suggests richness and depth, often used in academic settings",
      pronunciation: "mə-ro͞on′",
    },
    {
      word: "VIOLET",
      hint: "Purple flower color",
      extraLetters: "VIOLETPQ",
      meaning:
        "A bluish-purple color that corresponds to the short wavelength end of the visible spectrum",
      pronunciation: "vī′ə-lĭt",
    },
    {
      word: "INDIGO",
      hint: "Deep blue-purple color",
      extraLetters: "INDIGOXZ",
      meaning:
        "A deep blue-purple color traditionally considered the sixth color of the rainbow spectrum",
      pronunciation: "ĭn′dĭ-gō′",
    },
    {
      word: "CYAN",
      hint: "Greenish-blue printer color",
      extraLetters: "CYANXZPQ",
      meaning:
        "A greenish-blue color that is one of the primary colors in the CMYK color model used in printing",
      pronunciation: "sī′ăn",
    },
    {
      word: "MAGENTA",
      hint: "Purplish-red printer color",
      extraLetters: "MAGENTPX",
      meaning:
        "A purplish-red color that is one of the primary colors in the CMYK color model used in printing",
      pronunciation: "mə-jĕn′tə",
    },
    {
      word: "LIME",
      hint: "Bright green citrus color",
      extraLetters: "LIMEPQXZ",
      meaning:
        "A bright, light green color that resembles the citrus fruit, known for its vibrant intensity",
      pronunciation: "līm",
    },
    {
      word: "OLIVE",
      hint: "Yellowish-green color of the fruit",
      extraLetters: "OLIVEPQZ",
      meaning:
        "A dark yellowish-green color that resembles unripe or green olives, often used in military contexts",
      pronunciation: "ŏl′ĭv",
    },
    {
      word: "MINT",
      hint: "Light green herb color",
      extraLetters: "MINTPQXZ",
      meaning:
        "A pale, cool green color that resembles the herb, associated with freshness and coolness",
      pronunciation: "mĭnt",
    },
    {
      word: "SALMON",
      hint: "Pinkish-orange fish color",
      extraLetters: "SALMONPQ",
      meaning:
        "A pinkish-orange color that resembles the flesh of the fish, soft and warm in appearance",
      pronunciation: "săm′ən",
    },
    {
      word: "TAN",
      hint: "Light brown skin tone",
      extraLetters: "TANPQXZ",
      meaning:
        "A pale yellowish-brown color that resembles sunbaked skin, associated with warmth and sand",
      pronunciation: "tăn",
    },
    {
      word: "BEIGE",
      hint: "Light sandy color",
      extraLetters: "BEIGQXZ",
      meaning:
        "A very light brown color that is often used as a neutral background in interior design",
      pronunciation: "bāzh",
    },
    {
      word: "CREAM",
      hint: "Off-white dairy color",
      extraLetters: "CREAMPQZ",
      meaning:
        "A very pale yellow-white color that resembles dairy cream, suggesting richness and softness",
      pronunciation: "krēm",
    },
    {
      word: "KHAKI",
      hint: "Dusty tan military color",
      extraLetters: "KHAKIPQZ",
      meaning:
        "A light brownish-yellow color that is commonly used in military uniforms and casual clothing",
      pronunciation: "kă′kē",
    },
    {
      word: "AMBER",
      hint: "Yellow-orange fossilized resin",
      extraLetters: "AMBERPQZ",
      meaning:
        "A warm honey-like yellow or orange color that resembles the fossilized tree resin",
      pronunciation: "ăm′bər",
    },
    {
      word: "CRIMSON",
      hint: "Deep red color",
      extraLetters: "CRIMSONZ",
      meaning:
        "A strong, deep red color inclining to purple, associated with depth and richness",
      pronunciation: "krĭm′zən",
    },
    {
      word: "SCARLET",
      hint: "Bright red color",
      extraLetters: "SCARLETQ",
      meaning:
        "A bright red color with a slightly orange tinge, associated with passion and intensity",
      pronunciation: "skär′lĭt",
    },
    {
      word: "RUBY",
      hint: "Deep red gemstone color",
      extraLetters: "RUBYPQXZ",
      meaning:
        "A deep red color that resembles the precious gemstone, suggesting luxury and value",
    ...
    },
    {
      ...
      extraLetters: "SAPHIREX",
      meaning:
        "A deep blue color that resembles the precious gemstone, suggesting depth and clarity",
      pronunciation: "săf′īr",
    },
    {
      word: "TURQUOISE",
      hint: "Blue-green gemstone color",
      extraLetters: "TURQOISX",
      meaning:
        "A greenish-blue color that resembles the semi-precious stone, associated with water and sky",
      pronunciation: "tûr′koiz",
    },
    {
      word: "JADE",
      hint: "Green ornamental stone color",
      extraLetters: "JADEPQXZ",
      meaning:
        "A pale to dark green color that resembles the ornamental stone, associated with Eastern cultures",
      pronunciation: "jād",
    },
    {
      word: "PEARL",
      hint: "Iridescent white gem color",
      extraLetters: "PEARLXZQ",
      meaning:
        "A translucent, lustrous white or pale color that resembles the organic gem, suggesting elegance",
      pronunciation: "pûrl",
    },
    {
      word: "IVORY",
      hint: "Creamy white tusk color",
      extraLetters: "IVORYQXZ",
      meaning:
        "An off-white color that resembles the material from elephant tusks, suggesting age and quality",
      pronunciation: "ī′və-rē",
    },
    {
      word: "EBONY",
      hint: "Dark black wood color",
      extraLetters: "EBONYPQZ",
      meaning:
        "A deep black color that resembles the dark wood, suggesting strength and elegance",
      pronunciation: "ĕb′ə-nē",
    },
    {
      word: "MAHOGANY",
      hint: "Reddish-brown wood color",
      extraLetters: "MAHOGANX",
      meaning:
        "A reddish-brown color that resembles the hardwood, associated with fine furniture and richness",
