  ...
  words: [
    {
      word: "PARIS",
      hint: "French capital",
      extraLetters: "PARISXZQ",
      meaning:
        "The capital and most populous city of France, known for the Eiffel Tower and Louvre Museum",
      pronunciation: "pâr′ĭs",
    },
    {
      word: "LONDON",
      hint: "UK capital",
      extraLetters: "LONDONYW",
      meaning:
        "The capital and largest city of England and the United Kingdom, situated on the River Thames",
      pronunciation: "lŭn′dən",
    },
    {
      word: "TOKYO",
      hint: "Japan capital",
      extraLetters: "TOKYOZWP",
      meaning:
        "The capital and most populous city of Japan, known for its modern technology and traditional culture",
      pronunciation: "tō′kē-ō′",
    },
    {
      word: "ROME",
      hint: "Italian capital",
      extraLetters: "ROMEQPZ",
      meaning:
    ...
    },
    {
      word: "BERLIN",
      hint: "German capital",
      extraLetters: "BERLINXZ",
      meaning:
        "The capital and largest city of Germany, known for its history, art scene, and modern architecture",
      pronunciation: "bər-lĭn′, bĕr-lĭn′",
    },
    {
      word: "MOSCOW",
      hint: "Russian capital",
      extraLetters: "MOSCOWYW",
      meaning:
        "The capital and most populous city of Russia, known for its historic buildings like the Kremlin and Red Square",
      pronunciation: "mŏs′kō′, -kou′",
    },
    {
      word: "CAIRO",
      hint: "Egyptian capital",
      extraLetters: "CAIROZYQ",
      meaning:
        "The capital of Egypt and largest city in the Arab world, located near the ancient pyramids of Giza",
      pronunciation: "kī′rō",
    },
    {
      word: "BEIJING",
    ...
    {
      word: "DELHI",
      hint: "Indian capital region",
      extraLetters: "DELHIXZQ",
      meaning:
        "The metropolitan area in India that includes New Delhi, the capital of India",
      pronunciation: "dĕl′ē",
    },
    {
      word: "SYDNEY",
