...
export const mythologyTopic: Topic = {
  ...
  words: [
    ...
    },
    {
      ...
      extraLetters: "RAZYXWQP",
      meaning:
        "Egyptian deity of the sun and creator of all life, often depicted with a falcon head",
      pronunciation: "rä",
    },
    {
      word: "ISIS",
      hint: "Egyptian goddess",
      extraLetters: "ISQPWXZY",
      meaning:
        "Egyptian goddess of healing, magic, marriage, and protection, sister and wife of Osiris",
      pronunciation: "ī′sĭs",
    },
    {
      word: "OSIRIS",
