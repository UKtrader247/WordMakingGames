  ...
  words: [
    {
      ...
      extraLetters: "COMPUTERZQ",
      meaning:
        "An electronic device that manipulates information or data, capable of storing, retrieving, and processing data",
    ...
    },
    {
      ...
      extraLetters: "TABLETZXQ",
      meaning:
        "A portable device with a touchscreen interface and capabilities similar to a computer",
      pronunciation: "tăb′lĭt",
    },
    {
      word: "LAPTOP",
      hint: "Portable computer",
      extraLetters: "LAPTOPZXQ",
