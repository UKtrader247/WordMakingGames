...
export const travelTopic: Topic = {
  ...
  words: [
    ...
    },
    {
      word: "VISA",
      hint: "Entry permit",
      extraLetters: "VISAZXQPW",
      meaning:
        "An endorsement on a passport indicating that the holder is allowed to enter, leave, or stay in a country",
      pronunciation: "vē′zə",
    },
    {
      word: "LUGGAGE",
    ...
    },
    {
      word: "MAP",
      hint: "Location guide",
      extraLetters: "MAPZXQWKL",
      meaning:
        "A diagrammatic representation of an area showing physical features, cities, roads, etc.",
      pronunciation: "măp",
    },
    {
      word: "COMPASS",
      hint: "Direction finder",
      extraLetters: "COMPASZXQ",
      meaning:
    ...
    },
    {
      ...
      extraLetters: "GPSZXQWKL",
      meaning:
        "Global Positioning System; a satellite navigation system used to determine ground position and velocity",
